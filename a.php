...
function change()
{
    ...
    <body onload="change()"  style="background-image: url(wood.jpg);background-attachment: scroll;background-size: cover">
        <?php
       $Restaurnt1=$_GET["text1"];
        $Entertainemt1=$_GET["text2"];
        $Wines1=$_GET["text3"];
       #
        ...
        $db=  mysql_select_db("test") or die(mysql_errno());
            ...
            $sql="insert into Eventlist(Restaurnt,Entertainment,Wines)  values('$Restaurnt1','$Entertainemt1','$Wines1')";
            $res=mysql_query($sql);
              ...
              <div class="nav_pasition">
                  ...
                  <ul>
                     <!-- <li><a href="index.html"><div style="position: absolute;left:250px;top:20px"><img src="imagesa.jpg" alt="" height="100" width="120" /></a></div></li>-->
                      ...
                      <li><a href="1.htm" class="home">Home</a></li>
                    <li><a href="2.htm" class="home">Gallery</a></li>
                    <li><a href="3.htm" class="home">Menu</a></li>
                    <li><a href="alertt1.html" class="home">Booking</a></li>
                     <li><a href="alertt.html" class="home">Feedback</a></li>
                      <li><a href="12.html" class="home">Contact us</a></li>
                       <li><a href="9.html" class="home">Sign up</a></li>
                  </ul>
                </div>
              </div>
            </div>
   ...
   <div class="newsticker-jcarousellite"
        style="position: absolute; left: 1000px;top: 250px;color: #000;">
				...
				Restaurants:
                            ...
                            <div class="info" style="color:#fff;font-size: 13px;">
