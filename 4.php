...
<br>
   ...
   <div style="position: absolute;left:330px;top:100px">
     ...
     <p style="font-family: Mistral; font-size: 30px; color: #fff">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<input type="text" name="text1"></p><br>
          <p style="font-family: Mistral; font-size: 30px; color: #fff">Password&nbsp;&nbsp;<input type="password" name="text2"></p><br>
          <p style="font-family: Mistral; font-size: 30px; color: #fff">Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="4" cols="50" name="text3">
                     </textarea></p><br>
