 ...
 */
        ...
        if($Name1||$password1)
            {
            echo 'alert("All the fields should be field");';
            }
            ...
            while($row = mysql_fetch_array($res))
  {
   ...
   if((strcmp($Name1,$row['Name']))&&(strcmp($password1,$row['password'])))
           {
...
END;
			     ...
			     $con1=mysql_connect("localhost","root","root") or die(mysql_errno());
                                $db1=  mysql_select_db("test") or die(mysql_errno());
