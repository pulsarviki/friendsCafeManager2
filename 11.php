  ...
  <div class="main">
   ...
   <div style="position: absolute;left:25px;top:250px">
     ...
     <table style="border-style: solid;border-color: #000;border-width: 5px;"">
             <tr>
             <td>
              <p style="font-family: Mistral; font-size: 30px; color: #000">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="text1" id="text1"></p>
         <br>
         <p style="font-family: Mistral; font-size: 30px; color: #000">Password&nbsp;&nbsp;<input type="password" name="text2" id="text2"></p>
     <br>
     <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="login" onclick="validateform()"></p>
